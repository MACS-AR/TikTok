...
macs = Client('TikTok', api_id=APP_ID, api_hash=API_HASH, bot_token=BOT_TOKEN)
...
@macs.on_message(filters.command('start') & filters.private)
async def _start(bot, update):
  await update.reply_text(f"** مرحبا أنا بوت تحميل من التيكتوك يمكنك تحميل الفيديوهات او المقاطع الصوتية من هنا فقط ارسل رابط المقطع هنا مطور البوت @MACS37**", True, reply_markup=InlineKeyboardMarkup(START_BUTTONS))

# Downloader for tiktok
@macs.on_message(filters.regex(pattern='.*http.*') & filters.private)
